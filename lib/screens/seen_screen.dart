...
class _SeenScreenState extends State<SeenScreen> {
  late List<Movie> seenList = [];
  final DatabaseService _databaseService = DatabaseService();

  @override
  void initState() {
    super.initState();
    _databaseService.getWatchlist().then((seen) {
      setState(() {
        seenList = seen;
      });
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: seenList.isEmpty
          ? const Center(
              child: Text('No movies or series in your watch list'),
            )
          : Padding(
